import { BookOpen, MapPin, GraduationCap, Calculator, FlaskConical, Languages, Palette, Award, DollarSign, Calendar, TrendingUp } from 'lucide-react';
          ...
          <div className="hero-text-side">
            ...
            <div className="search-bar-pill">
              <div className="search-divider">
                ...
                <ComboBox placeholder="Môn học" options={["Toán học", "Tiếng Anh", "Vật lý", "Hóa học", "Ngữ văn"]} className="" inputClassName="search-input" />
              </div>
              <div className="search-divider">
                <GraduationCap size={18} className="search-icon" />
                <ComboBox placeholder="Lớp" options={["Mầm non", "Lớp 1", "Lớp 2", "Lớp 3", "Lớp 4", "Lớp 5", "Lớp 6", "Lớp 7", "Lớp 8", "Lớp 9", "Lớp 10", "Lớp 11", "Lớp 12", "Đại học", "Người đi làm"]} className="" inputClassName="search-input" />
              </div>
              <div className="search-divider" style={{border: 'none'}}>
                <MapPin size={18} className="search-icon" />
                <input type="text" placeholder="Địa điểm" className="search-input" />
              </div>
              <button className="btn btn-primary btn-search-submit">Tìm Kiếm</button>
            </div>
          </div>
