  ...
  const [reviews, setReviews] = useState([
    {
      ...
      stars: 5,
      time: "1 ngày trước",
      content: "Thầy giáo trẻ nhưng giảng bài rất có tâm. Con tôi học chậm nhưng thầy rất kiên nhẫn giảng đi giảng lại. Cảm ơn thầy!",
      replies: ["Dạ vâng, em cảm ơn chị ạ. Bé Lan rất ngoan và chịu khó, chỉ cần hướng dẫn đúng cách bé sẽ tiến bộ rất nhanh."]
    },
    {
      id: 2,
      author: "Em Tuấn Lớp 10",
      stars: 4,
      time: "1 tuần trước",
      content: "Anh dạy rất hay, giải bài khó dễ hiểu.",
      replies: []
    }
  ]);
